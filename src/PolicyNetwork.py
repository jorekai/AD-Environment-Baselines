...
class CustomPolicy(FeedForwardPolicy):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch,
                 reuse=False, obs_phs=None, dueling=True, **kwargs):
        super(CustomPolicy, self).__init__(sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse,
                                           ...
                                           layer_norm=True, layers=[config.HIDDEN_NEURONS, config.HIDDEN_NEURONS, config.HIDDEN_NEURONS, config.HIDDEN_NEURONS, config.HIDDEN_NEURONS], **kwargs)
